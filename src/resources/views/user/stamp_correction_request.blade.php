        ...
        <nav class="main-nav">
            <ul class="main-nav__list">
                <li class="main-nav__item">
                    <a href="{{ route('stamp_correction.index', ['status' => 'pending']) }}"
                       class="main-nav__link @if (request('status', 'pending') === 'pending') is-active @endif">
                        承認待ち
                    </a>
                </li>
                <li class="main-nav__item">
                    <a href="{{ route('stamp_correction.index', ['status' => 'approved']) }}"
                       class="main-nav__link @if (request('status') === 'approved') is-active @endif">
                        承認済み
                    </a>
                </li>
            </ul>
    ...
    <table class="attendance-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="detail-col">
                    <a href="{{ route('attendance.detail.show', ['id' => $application->id]) }}" class="detail-link">
                        詳細
                    </a>
                </td>
            </tr>
